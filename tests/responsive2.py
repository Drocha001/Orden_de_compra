...
# Asegurar que el archivo KV se encuentra en la misma carpeta
KV_FILE = os.path.join(os.path.dirname(__file__), "respon.kv")
...
class Test(MDApp):
    def build(self):
        Window.maximize()
        Builder.load_file(KV_FILE)  # Cargar el archivo KV
